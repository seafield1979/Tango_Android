...
public class EditBookDialogFragment extends DialogFragment implements OnClickListener{
     ...
     * Constructor
     */
    public static EditBookDialogFragment createInstance(EditBookDialogCallbacks callbacks) {
        return createInstance(callbacks, null);
    }

    public static EditBookDialogFragment createInstance(EditBookDialogCallbacks callbacks, TangoBook book) {
