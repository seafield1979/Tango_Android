...
import com.sunsunsoft.shutaro.tangobook.icon.UIconManager;
...
import com.sunsunsoft.shutaro.tangobook.debug.DebugDialogs;
import com.sunsunsoft.shutaro.tangobook.fragment.*;
        ...
        UDialogCallbacks, UIconWindowSubCallbacks
{
    ...
    private void copyIcon(UIcon icon) {
        UIconManager iconManager =  icon.getParentWindow().getIconManager();
        ...
        icon.getParentWindow().sortIcons(true);
    }
    ...
    public boolean UButtonClicked(int id, boolean pressedOn) {
        switch (id) {
            ...
            case TrashDialogButtonOK:
                ...
                UIconWindowSub subWindow = mIconWinManager.getSubWindow();
                if (subWindow.isShow()) {
                    if (subWindow.getWindowCallbacks() != null) {
