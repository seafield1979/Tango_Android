package com.sunsunsoft.shutaro.tangobook.uview.text;
...
import com.sunsunsoft.shutaro.tangobook.fragment.UEditDialogCallbacks;
import com.sunsunsoft.shutaro.tangobook.fragment.UEditDialogFragment;
...
public class UEditText extends UTextView implements UEditDialogCallbacks {
    ...
    {
        super(text, textSize, priority, alignment, canvasW, multiLine, true, true,
